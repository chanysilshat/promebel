...
function pars($id_sect,$name_sect,$ss_sect){
...
echo '='.$counter;	
	...
	//$array_xml[$index_assoc]['anons']=$value[anons];
	$array_xml[$index_assoc]['image']=$images_url;
	$array_xml[$index_assoc]['categories']['id']=$id_sect;
	$array_xml[$index_assoc]['categories']['name']=$name_sect;
...
$xml_file = $xml_user_info->asXML('category'.$id_sect.'.xml');
...
pars($_POST['dir'],$_POST['name'],$_POST['url']);
