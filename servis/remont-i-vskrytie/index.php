...
$APPLICATION->SetTitle("Ремонт и вскрытие");
?>
<div class="catalog">
		...
		<ul class="catalog-menu-mobile-menu">
			<li>
				...
				<ul>
					...
					<li class="catalog-menu-mobile-link"><a href="/servis/remont-i-vskrytie/">Ремонт и вскрытие</a></li>
	...
	<?$APPLICATION->IncludeComponent(
		...
		Array(
			...
			"EDIT_TEMPLATE" => "",
			"PATH" => "/include/remont-i-vskrytie.php"
		)
	);?>
	</div>
</div>
