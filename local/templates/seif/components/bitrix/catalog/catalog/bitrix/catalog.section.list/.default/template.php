			...
			<?if($arResult['SECTIONS']['0']['DEPTH_LEVEL'] == 1):?>
				<?foreach ($arResult['SECTIONS'] as &$arSection):
					...
					<?if($arSection['DEPTH_LEVEL'] == 1):?>
						<a href="<?=$arSection['SECTION_PAGE_URL']?>" class="catalog-list-panel">
							<div class="catalog-list-img" style="background: url(<?=$arSection['PICTURE']['SRC']?>)no-repeat 50%"></div>
							<div class="catalog-list-name"><?=$arSection['NAME']?></div>
						</a>
					<?endif;?>
				<?endforeach;?>
			<?endif;?>
			<?if($arResult['SECTIONS']['0']['DEPTH_LEVEL'] >= 2):?>
				<?foreach ($arResult['SECTIONS'] as &$arSection):
					$this->AddEditAction($arSection['ID'], $arSection['EDIT_LINK'], $strSectionEdit);
					$this->AddDeleteAction($arSection['ID'], $arSection['DELETE_LINK'], $strSectionDelete, $arSectionDeleteParams);?>
