...
<div class="catalog">
	...
	<div class="catalog-menu mobile">
		<div class="catalog-menu-mobile-title">Меню каталога</div>
		<ul class="catalog-menu-mobile-menu">
			<?foreach($sectionLinc[0]['CHILD'] as $key => $value):?>
				<li>
					<a href="<?=$value['SECTION_PAGE_URL']?>" class="catalog-menu-mobile-link"><?=$value['NAME']?></a>
					<?if($value['CHILD']):?>
						<ul>
							<?foreach($value['CHILD'] as $key => $value1):?>
								<?if($value1):?>
									<li><a href="<?=$value1['SECTION_PAGE_URL']?>"><?=$value1['NAME']?></a></li>
								<?endif;?>
							<?endforeach;?>
						</ul>
					<?endif;?>
	...
	<div class="catalog-menu desktop">
		<ul class="catalog-menu-one ">
			<?foreach($sectionLinc[0]['CHILD'] as $key => $value):?>
				<li>
					<a href="<?=$value['SECTION_PAGE_URL']?>" class="catalog-menu-link-one"><?=$value['NAME']?></a>
					<?if($value['CHILD']):?>
						<ul class="catalog-menu-two">
							<?foreach($value['CHILD'] as $key => $value1):?>
								<?if($value1):?>
									<li>
										<a href="<?=$value1['SECTION_PAGE_URL']?>" class="catalog-menu-link-two"><?=$value1['NAME']?></a>
									</li>
								<?endif;?>
							<?endforeach;?>
						</ul>
	...
	<div class="catalog-block">
		...
		<?
		$rsSections = CIBlockSection::GetList(array(),array('IBLOCK_ID' => 2, '=CODE' => $arResult['VARIABLES']['SECTION_CODE']));
		if ($arSection1 = $rsSections->Fetch()):?>
			<?if(($arSection1['RIGHT_MARGIN'] - $arSection1['LEFT_MARGIN']) == 1):?>
				<div class="catalog-title-vid">
					<div class="catalog-title">
						<?=$arSection1['NAME']?>
					</div>
					<div class="catalog-vid">
						<div class="catalog-vid-line">
							<svg width="20" height="20">
						        <use xlink:href="#vid-line"></use>
						    </svg>
						</div>
						<div class="catalog-vid-panel active">
							<svg width="20" height="20">
						        <use xlink:href="#vid-panel"></use>
						    </svg>
						</div>
					</div>
				</div>
			<?else:?>
				<div class="catalog-title"><?=$arSection1['NAME']?></div>
			<?endif;?>
		<?endif;?>
