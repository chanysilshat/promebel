	...
	BX.Sale.OrderAjaxComponent = {
		...
		alterProperty: function(settings, propContainer)
		{
			...
			for (i = 0; i < add.length; i++)
			{
				...
				BX.addClass(add[i], 'btn btn-default btn-sm btn-yr-file');
			...
			/*console.log(propContainer.getElementsByClassName('btn-yr-file')[0]);
			propContainer.getElementsByClassName('btn-yr-file').value = '11111';*/

			
			/*let vv = document.querySelector(".btn-yr-file");
			vv.value = '222222';*/
