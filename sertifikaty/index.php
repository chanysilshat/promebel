...
<div class="catalog">
	<div class="catalog-menu mobile">
		...
		<ul class="catalog-menu-mobile-menu">
			<li>
				...
				<ul>
					<li class="catalog-menu-mobile-link"><a href="/sertifikaty/">Сертификаты</a></li>
	...
	<div class="catalog-menu content-menu desktop">
		<ul class="catalog-menu-one">
			<li class="active"><a href="/sertifikaty/" class="catalog-menu-link-one">Сертификаты</a></li>
	...
	<div class="content">
	 <?$GLOBALS['arrFilter']=array("SECTION_ID" => 127);?>
