...
$APPLICATION->SetTitle("Инструкции по эксплуатации замков");
?>
<div class="catalog">
		...
		<ul class="catalog-menu-mobile-menu">
			<li>
				...
				<ul>
					...
					<li class="catalog-menu-mobile-link"><a href="/instruktsii-po-ekspluatatsii-zamkov/">Инструкции по эксплуатации замков</a></li>
	...
	<div class="catalog-menu content-menu desktop">
		<ul class="catalog-menu-one">
			...
			<li><a href="/litsenzii/" class="catalog-menu-link-one">Лицензии</a></li>
			<li class="active"><a href="/instruktsii-po-ekspluatatsii-zamkov/" class="catalog-menu-link-one">Инструкции по эксплуатации замков</a></li>
			<li><a href="/instruktsii-po-sborke-mebeli/" class="catalog-menu-link-one">Инструкции по сборке мебели</a></li>
		</ul>
	</div>
	<div class="content">
	 <?$GLOBALS['arrFilter']=array("SECTION_ID" => 129);?>
	...
	Array(
		...
		"EDIT_TEMPLATE" => "",
		"PATH" => "/include/instruktsii_zamki.php"
	)
);?>
</div>
</div>
