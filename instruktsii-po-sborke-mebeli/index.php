...
$APPLICATION->SetTitle("Инструкции по сборке мебели");
?>
<div class="catalog">
		...
		<ul class="catalog-menu-mobile-menu">
			<li>
				...
				<ul>
					...
					<li class="catalog-menu-mobile-link"><a href="/instruktsii-po-sborke-mebeli/">Инструкции по сборке мебели</a></li>
				</ul>
			</li>
		</ul>
	</div>
	<div class="catalog-menu content-menu desktop">
		<ul class="catalog-menu-one">
			...
			<li class="active"><a href="/instruktsii-po-sborke-mebeli/" class="catalog-menu-link-one">Инструкции по сборке мебели</a></li>
		</ul>
	</div>
	<div class="content">
	 <?$GLOBALS['arrFilter']=array("SECTION_ID" => 130);?>
